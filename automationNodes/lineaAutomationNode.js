...
const providers = [
  process.env.LINEA_WSS
];
const randomProvider = Math.floor(Math.random() * providers.length);
const provider = new ethers.providers.WebSocketProvider(
  providers[randomProvider]
);
const automationLayerContractAddress = "0xCa9A5C76e9c792c9106C9c1376521bAE52244790"

const sequencerAddress = "0x08399e90178e2E51e160394123C8301E27AFBe92";
