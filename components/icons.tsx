...
export const Icons = {
  ...
  logo: (props: LucideProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" transform="rotate(26 0 0)" {...props}>
      <polygon points="70,10 90,50 70,90 50,50" fill="currentColor" stroke="currentColor" strokeLinejoin="round"
               strokeWidth="4" />
      <polygon points="70,10 30,10 10,50 50,50" fill="none" stroke="currentColor" strokeLinejoin="round"
               strokeWidth="4" />
      <polygon points="50,50 10,50 30,90 70,90" fill="none" stroke="currentColor" strokeLinejoin="round"
               strokeWidth="4" />
    </svg>
  ),
  netflix: (props: LucideProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111 30" {...props}>
      <g>
        <path
