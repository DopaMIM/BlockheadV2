...
const providerSepolia = new providers.JsonRpcProvider(
  "https://sepolia.infura.io/v3/" + INFURA_API_KEY
)
providerSepolia.pollingInterval = 3000
const providerLinea = new providers.JsonRpcProvider(
  "https://linea-mainnet.infura.io/v3/" + INFURA_API_KEY
)
providerLinea.pollingInterval = 3000
const providerLineaTestnet = new providers.JsonRpcProvider(
