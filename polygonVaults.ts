...
const contracts = [WETH,LINK,AAVE,CRV,BAL,dQUICK,WBTC,GHST,camWMATIC,camWETH,camAAVE,camWBTC,camDAI,WMATIC,FXS,,,,SAND]
...
var liquidationMinimum = 1000000000000000000; //10000000000000000000 = $100
var gas = 1001000000000

const init = async () => {
    
    const web3 = new Web3(process.env.POLYGON_RPC);

    var contractAddress = contracts[0]
...
//Public Fantom url: https://rpc.ftm.tools/
    ...
    var vaultCount = await contract.methods.vaultCount().call();
    ...
    const exists = await contract.methods.exists(vaultID).call();
        ...
        if (exists == true) 
            {const checkLiquidation = await contract.methods.checkLiquidation(vaultID).call();
                ...
                if (checkLiquidation == true)
                    ...
                    if (checkCost > liquidationMinimum) //10000000000000000000
                    {(async() => {
        ...
        if (vaultID == vaultCount) {console.log("Next Asset")}

    }


    var contractAddress = contracts[1]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[2]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[3]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[4]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[5]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[6]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[7]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[8]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[9]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[10]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[11]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[12]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[13]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[14]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[15]
    var contract = new web3.eth.Contract(abi, contractAddress)
    ...
    var contractAddress = contracts[16]
    var contract = new web3.eth.Contract(abi, contractAddress)
